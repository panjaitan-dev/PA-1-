    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="navbar">
        <div class="container">
            ...
            <div class="logo-wrapper">
                ...
                <div class="logo-divider"></div>
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Geo<span>Toba</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('informasi') ? 'active' : ''); ?>" href="<?php echo e(url('/informasi')); ?>">Informasi</a></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('destinasi*') ? 'active' : ''); ?>" href="#" data-bs-toggle="dropdown">Destinasi</a>
                        <ul class="dropdown-menu">
                            <li><h6 class="dropdown-header"><i class="fas fa-tag me-1"></i> KATEGORI DESTINASI</h6></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/destinasi/alam')); ?>">Destinasi Alam</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/destinasi/buatan')); ?>">Destinasi Buatan</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/destinasi/budaya')); ?>">Destinasi Budaya</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/destinasi')); ?>">Semua Destinasi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('galeri') ? 'active' : ''); ?>" href="<?php echo e(url('/galeri')); ?>">Galeri</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('berita') ? 'active' : ''); ?>" href="<?php echo e(url('/berita')); ?>">Berita</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('kontak') ? 'active' : ''); ?>" href="<?php echo e(url('/kontak')); ?>">Kontak</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(url('/')); ?>">Beranda</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/informasi')); ?>">Informasi</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/galeri')); ?>">Galeri</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/berita')); ?>">Berita</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/kontak')); ?>">Kontak</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <h5>Destinasi</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(url('/destinasi/alam')); ?>">Destinasi Alam</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/destinasi/buatan')); ?>">Destinasi Buatan</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/destinasi/budaya')); ?>">Destinasi Budaya</a></li>
                        <li class="mb-2"><a href="<?php echo e(url('/destinasi')); ?>">Semua Destinasi</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <h5>Kontak</h5>
...
</html><?php /**PATH D:\Semester 2\Proyek Akhir Tahun I\PA1 FINALL\PA-1-\resources\views/layouts/app.blade.php ENDPATH**/ ?>