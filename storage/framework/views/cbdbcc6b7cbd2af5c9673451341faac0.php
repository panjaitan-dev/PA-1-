...
<?php $__env->startSection('title', 'Berita - Geosite Danau Toba'); ?>
...
<style>
    ...
    * {
    ...
    .berita-hero-bg {
        ...
        width: 100%;
        height: 100%;
        background: url('<?php echo e(asset("image/berita.jpg")); ?>') center/cover no-repeat;
        transform: scale(1);
...
<section class="section-berita" id="berita-section">
    <div class="container">
        ...
        <div class="berita-grid">
            ...
            <div class="berita-card" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                <div class="berita-image">
                    <?php if($item->gambar): ?>
                        <img src="<?php echo e($item->gambar); ?>" alt="<?php echo e($item->judul); ?>" loading="lazy">
                    <?php else: ?>
                        <img src="<?php echo e(asset('image/berita-default.jpg')); ?>" alt="Berita">
                    <?php endif; ?>
                ...
                <div class="berita-content">
                    ...
                    <h3 class="berita-title"><?php echo e($item->judul); ?></h3>
                    <p class="berita-excerpt"><?php echo Str::limit(strip_tags($item->konten), 120); ?></p>
                    <div class="readmore-wrapper" onclick="event.stopPropagation(); openModal(<?php echo e($item->id); ?>)">
                    ...
                    <div class="berita-stats">
                        <div class="stat-item">
                            ...
                            <span><?php echo e(number_format($item->views ?? 0)); ?> views</span>
                        </div>
                        <div class="stat-item">
        ...
        <div class="pagination-wrapper">
            <?php echo e($berita->links('pagination::bootstrap-5')); ?>
...
<script>
    ...
    const beritaData = <?php echo json_encode($berita->items(), 15, 512) ?>;
    
    function openModal(id) {
        const berita = beritaData.find(b => b.id === id);
        if (!berita) return;
        
        document.getElementById('modalImage').src = berita.gambar || '<?php echo e(asset("image/berita-default.jpg")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 2\pa real 1\Proyek akhir 1 Real\resources\views/pages/berita.blade.php ENDPATH**/ ?>