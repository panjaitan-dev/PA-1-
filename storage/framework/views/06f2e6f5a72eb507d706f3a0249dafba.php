...
<?php $__env->startSection('title', 'Destinasi ' . $kategori . ' - Geosite Danau Toba'); ?>
...
<style>
    ...
    .kategori-hero {
        height: 40vh;
        min-height: 350px;
        background: linear-gradient(135deg, rgba(0,51,102,0.75), rgba(0,51,102,0.55)), url('/image/destinasi-<?php echo e(strtolower($kategori)); ?>.jpg');
...
<section class="kategori-hero">
    <div data-aos="fade-up">
        <h1>Destinasi <?php echo e($kategori); ?></h1>
...
<section class="destinasi-section">
    <div class="container">
        <div class="destinasi-grid">
            ...
            <div class="dest-card" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="card-image">
                    <img src="<?php echo e($item->gambar); ?>" alt="<?php echo e($item->nama); ?>">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 2\pa real 1\Proyek akhir 1 Real\resources\views/destinasi/kategori.blade.php ENDPATH**/ ?>