...
<?php $__env->startSection('title', 'Sejarah Caldera Toba - Geosite Danau Toba'); ?>
...
<section class="section">
    <div class="container">
        ...
        <div class="sejarah-grid">
            <?php $__empty_1 = true; $__currentLoopData = $sejarahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="sejarah-item <?php echo e($index % 2 == 1 ? 'reverse' : ''); ?>" data-aos="fade-<?php echo e($index % 2 == 0 ? 'right' : 'left'); ?>">
                <div class="sejarah-image">
                    <?php if($item->gambar): ?>
                        <img src="<?php echo e($item->gambar); ?>" alt="<?php echo e($item->judul); ?>">
                    <?php else: ?>
                        <img src="/image/sejarah<?php echo e($index+1); ?>.jpg" alt="<?php echo e($item->judul); ?>">
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 2\pa real 1\Proyek akhir 1 Real\resources\views/pages/informasi.blade.php ENDPATH**/ ?>