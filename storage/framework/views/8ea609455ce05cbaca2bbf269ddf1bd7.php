...
<footer class="footer-full">
    <div class="footer-full-container">
        ...
        <div class="footer-full-btn">
            <a href="<?php echo e(url('/')); ?>" class="back-btn">← Kembali ke Dashboard</a>
        </div>
...
</html> <?php /**PATH D:\Semester 2\pa real 1\Proyek akhir 1 Real\resources\views/geosite/liang-sipege.blade.php ENDPATH**/ ?>